    ...
    <main className="min-h-screen bg-luxury-black text-white px-6 py-12 md:py-16">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-end border-b border-white/5 pb-6 mb-8">
          <div>
            <Link href="/staff" className="text-gold-primary/70 hover:text-gold-primary text-[10px] uppercase tracking-widest flex items-center mb-3">
              <ChevronLeft size={12} className="mr-1" /> Back to Staff Portal
            </Link>
